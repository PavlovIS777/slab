...
testNum = 1
while(os.path.isfile("./testSys/randTests/test"+str(testNum)+".dat")):
    testPath = "./testSys/randTests/test"+str(testNum)+".dat"
    with open('./testSys/randTests/test'+str(testNum)+'.dat', 'r') as my_file:
